  ...
  <div className="min-h-screen flex bg-page">
    <div className="hidden lg:flex w-[46%] xl:w-[42%] brand-gradient text-white flex-col justify-between p-10 xl:p-12">
      <div className="flex items-center gap-2.5">
        ...
        <span className="font-poppins text-2xl font-semibold tracking-tight">
          Openlytic
        </span>
      </div>
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-4 text-white/75 text-lg leading-relaxed">
            See who opened your email, what they clicked, and when —
            automatically.
          </p>
        </div>
          ...
          {highlights.map((item) => (
            <div key={item.title} className="flex gap-3.5">
              ...
              <div>
                ...
                <p className="mt-0.5 text-white/70 text-sm leading-relaxed">
                  {item.body}
                </p>
              </div>
            </div>
      ...
      <p className="text-white/50 text-xs">
        Openlytic · Sales &amp; email intelligence for small teams
      </p>
    </div>
    ...
    <div className="flex-1 flex items-center justify-center p-6 lg:p-10">
      <div className="w-full max-w-md animate-fade-up">
        ...
        {subtitle && (
          <p className="mt-2 text-muted text-sm leading-relaxed">{subtitle}</p>
        )}
